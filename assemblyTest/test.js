...
var real___GLOBAL__sub_I_test_cc = asm["__GLOBAL__sub_I_test_cc"];
asm["__GLOBAL__sub_I_test_cc"] = function() {
...
var real__rotate = asm["_rotate"];
asm["_rotate"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__rotate.apply(null, arguments);
};
...
Module["asm"] = asm;
var __GLOBAL__sub_I_test_cc = Module["__GLOBAL__sub_I_test_cc"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__GLOBAL__sub_I_test_cc"].apply(null, arguments)
};
...
var _rotate = Module["_rotate"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_rotate"].apply(null, arguments)
};
