...
int av_dump(uint8_t *buf, size_t buf_size)
{
    ...
    int video_frames = fmt_ctx->streams[video_stream]->nb_frames;
    int audio_frames = fmt_ctx->streams[audio_stream]->nb_frames;
    return video_frames;
end:
