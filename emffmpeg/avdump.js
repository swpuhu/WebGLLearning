...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 10992000,
    DYNAMIC_BASE = 16234880,
    DYNAMICTOP_PTR = 10991840;
...
var wasmBinaryFile = 'avdump.wasm';
...
// STATICTOP = STATIC_BASE + 10990976;
...
// {{PRE_LIBRARY}}
  ...
  var ___tm_timezone=(stringToUTF8("GMT", 10991904, 4), 10991904);function _gmtime_r(time, tmPtr) {
  ...
  err('missing function: swr_alloc'); abort(-1);
  }

  function _swr_close(
  ) {
  err('missing function: swr_close'); abort(-1);
  }

  function _swr_convert(
  ) {
  err('missing function: swr_convert'); abort(-1);
  }

  function _swr_free(
  ) {
  err('missing function: swr_free'); abort(-1);
  }

  function _swr_init(
  ) {
  err('missing function: swr_init'); abort(-1);
  }

  function _swr_is_initialized(
  ) {
  err('missing function: swr_is_initialized'); abort(-1);
  }
...
var asmGlobalArg = {};
var asmLibraryArg = { "__assert_fail": ___assert_fail, "__clock_gettime": ___clock_gettime, "__handle_stack_overflow": ___handle_stack_overflow, "__lock": ___lock, "__syscall10": ___syscall10, "__syscall195": ___syscall195, "__syscall196": ___syscall196, "__syscall197": ___syscall197, "__syscall220": ___syscall220, "__syscall221": ___syscall221, "__syscall3": ___syscall3, "__syscall33": ___syscall33, "__syscall38": ___syscall38, "__syscall39": ___syscall39, "__syscall4": ___syscall4, "__syscall40": ___syscall40, "__syscall5": ___syscall5, "__syscall54": ___syscall54, "__syscall91": ___syscall91, "__unlock": ___unlock, "abort": _abort, "clock": _clock, "clock_gettime": _clock_gettime, "emscripten_get_sbrk_ptr": _emscripten_get_sbrk_ptr, "emscripten_memcpy_big": _emscripten_memcpy_big, "emscripten_resize_heap": _emscripten_resize_heap, "environ_get": _environ_get, "environ_sizes_get": _environ_sizes_get, "fd_close": _fd_close, "fd_fdstat_get": _fd_fdstat_get, "fd_read": _fd_read, "fd_seek": _fd_seek, "fd_write": _fd_write, "gettimeofday": _gettimeofday, "gmtime_r": _gmtime_r, "localtime_r": _localtime_r, "memory": wasmMemory, "mktime": _mktime, "nanosleep": _nanosleep, "round": _round, "roundf": _roundf, "setTempRet0": _setTempRet0, "strftime": _strftime, "swr_alloc": _swr_alloc, "swr_close": _swr_close, "swr_convert": _swr_convert, "swr_free": _swr_free, "swr_init": _swr_init, "swr_is_initialized": _swr_is_initialized, "table": wasmTable, "time": _time };
var asm = createWasm();
Module["asm"] = asm;
...
var _av_dump = Module["_av_dump"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["av_dump"].apply(null, arguments)
};
