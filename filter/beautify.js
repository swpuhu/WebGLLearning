...
import {beautify as shader} from './shaders.js'
...
export default function (gl, projectionMat) {
    ...
    const singleStepOffset = gl.getUniformLocation(program, 'singleStepOffset');
    const params = gl.getUniformLocation(program, 'params');

    gl.uniform2f(singleStepOffset, 1 / 640, 1 / 360);
    gl.uniform1f(params, 0.33);
