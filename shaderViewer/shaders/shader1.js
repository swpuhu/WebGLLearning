export default class TurnPageFrag {
    static turnpage_vert = `
      ...
      void main()
      {
          gl_Position = (CC_PMatrix * a_position) * vec4(1.0, -1.0, 1.0, 1.0);
    ...
    //   #define swap_x
      ...
      vec4 turnPage(vec2 fragCoord)
      {
          ...
          fragCoord = v_texCoord * resolution;
          vec2 uv = fragCoord.xy / resolution.yy;
        //   uv = v_texCoord * (resolution.x / resolution.y);
